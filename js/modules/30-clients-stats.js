...
function openClientDetail(phone) {
    ...
    document.getElementById('clientDetailCity').value = client.city || AppState.clientData[client.phone]?.city || '';
...
async function saveClientChanges() {
    ...
    const city = document.getElementById('clientDetailCity')?.value.trim() || '';
