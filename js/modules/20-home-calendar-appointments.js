...
// Mobile Mini Calendar (in Calendar Screen)
...
async function saveNewAppointment() {
    ...
    // Save client data (CPF/birthday) to backend
    if (phone && (cpf || birthday)) {
        ...
        // Dados de cliente salvos no backend via DB.atualizarCliente ao criar cliente
    }
...
async function saveAppointmentChanges() {
    ...
    if (result.ok) {
        // Save CPF/birthday to backend (via DB.atualizarCliente below)
