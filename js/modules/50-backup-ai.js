...
function getAIResponse(message) {
    ...
    if (lowerMsg.includes('cliente')) {
        ...
        return `ðŸ‘¥ VocÃª tem <strong>${numClients}</strong> clientes cadastrados.<br><br>
        Dica: Mantenha contato com seus clientes e envie promoÃ§Ãµes personalizadas!`;
    }
...
function handleBackupImport(event) {
    ...
    reader.onload = function(e) {
        try {
            ...
            if (!confirm('Isso irÃ¡ substituir todos os dados atuais. Deseja continuar?')) return;
