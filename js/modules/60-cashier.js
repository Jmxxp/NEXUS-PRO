...
function selectPaymentMethod(method) {
    ...
    // Mostrar/ocultar seleÃ§Ã£o de bandeira do cartÃ£o
    const cardBrandGroup = document.getElementById('cardBrandGroup');
    if (cardBrandGroup) {
...
function saveTransaction(index) {
    ...
    if (index !== null && index >= 0) {
        // EdiÃ§Ã£o - restaurar estoque antigo primeiro
        restoreProductStock(oldItems);
        
        // Salvar histÃ³rico (manter apenas Ãºltimas 10 ediÃ§Ãµes)
        const oldTransaction = AppState.transactions[index];
        let editHistory = oldTransaction.editHistory || [];
        
        // Adicionar registro de ediÃ§Ã£o com dados anteriores
        editHistory.push({
        ...
        // Limitar a 10 entradas no histÃ³rico
    ...
    renderCashier();
    showToast('MovimentaÃ§Ã£o salva!', 'success');
}
