...
## ⚠️ IMPORTANTE: Google Apps Script

**O script do backend DEVE ser gerado pelo app** através do Script Builder (Configurações → Criador de Script).

❌ **NÃO edite** o arquivo `COPIE_PARA_GOOGLE.gs` manualmente  
✅ **SEMPRE** use o Script Builder para gerar novos scripts

Se houver problemas com funcionalidades (ex: horário de almoço não aparece), **regenere o script** pelo app e reimplante no Google Apps Script.
